...
//     if(!this.map.has(key)){
//         this.map.set(key,{value,expiry: new Date(currentTime + duration)})
//         return false;
//     }else{
//         this.map.set(key,{value,expiry: new Date(currentTime + duration)})
//         return true;
...
// TimeLimitedCache.prototype.isKeyExpired = function(expiry) {
...
//     let count =0;
//     for (const [,{expiry}] of this.map) {
//         if(!this.isKeyExpired(expiry)){
//             count++;
//         }
//     }
//     return count;
