...
// const throttled2 = throttle(console.log, 1000);
// throttled2("log");
// throttled2(1);

// Input: t = 70, calls = [{"t":50,"inputs":[1]},{"t":75,"inputs":[2]},{"t":90,"inputs":[8]},{"t": 140, "inputs":[5,7]},{"t": 300, "inputs": [9,4]}]
const throttled3 = throttle(console.log, 700);
setTimeout(() => throttled3(1), 500);
setTimeout(() => throttled3(2), 750);
setTimeout(() => throttled3(8), 900);
